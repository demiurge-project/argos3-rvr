...
set(ARGOS_BUILD_FOR_RVR      FALSE)
set(ARGOS_BUILD_FOR_LOCALRVR FALSE)
...
if(ARGOS_BUILD_FOR STREQUAL "rvr")
  set(ARGOS_BUILD_FOR_RVR TRUE)
endif(ARGOS_BUILD_FOR STREQUAL "rvr")
# ARGOS_BUILD_FOR_LOCALEPUCK
if(ARGOS_BUILD_FOR STREQUAL "localrvr")
  set(ARGOS_BUILD_FOR_LOCALRVR TRUE)
endif(ARGOS_BUILD_FOR STREQUAL "localrvr")
