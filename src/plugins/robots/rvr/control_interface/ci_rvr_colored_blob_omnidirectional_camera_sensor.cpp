#include "ci_rvr_colored_blob_omnidirectional_camera_sensor.h"
...
namespace argos {
   ...
   int LuaEnableOmnidirectionalCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_RVRColoredBlobOmnidirectionalCameraSensor>(pt_lua_state, "colored_blob_omnidirectional_camera")->Enable();
      return 0;
   }
#endif
   ...
   int LuaDisableOmnidirectionalCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_RVRColoredBlobOmnidirectionalCameraSensor>(pt_lua_state, "colored_blob_omnidirectional_camera")->Disable();
      return 0;
   }
#endif
...
#ifdef ARGOS_WITH_LUA
   void CCI_RVRColoredBlobOmnidirectionalCameraSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_RVRColoredBlobOmnidirectionalCameraSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   const CCI_RVRColoredBlobOmnidirectionalCameraSensor::SReadings& CCI_RVRColoredBlobOmnidirectionalCameraSensor::GetReadings() const {
      return m_sReadings;
   }
