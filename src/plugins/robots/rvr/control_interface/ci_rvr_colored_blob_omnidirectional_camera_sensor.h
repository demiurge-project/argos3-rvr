#ifndef CI_RVRCOLORED_BLOB_OMNIDIRECTIONAL_CAMERA_SENSOR_H
#define CI_RVRCOLORED_BLOB_OMNIDIRECTIONAL_CAMERA_SENSOR_H

namespace argos {
   class CCI_RVRColoredBlobOmnidirectionalCameraSensor;
}
...
namespace argos {
    ...
    */
   class CCI_RVRColoredBlobOmnidirectionalCameraSensor: public CCI_Sensor {
   ...
   public:
       ...
       * Constructor
       */
      CCI_RVRColoredBlobOmnidirectionalCameraSensor() {}

      /**
       * Destructor
       */
      virtual ~CCI_RVRColoredBlobOmnidirectionalCameraSensor() {}
