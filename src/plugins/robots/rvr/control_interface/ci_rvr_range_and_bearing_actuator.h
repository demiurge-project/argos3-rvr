/**
 * @file <argos3/plugins/robots/rvr/control_interface/ci_range_and_bearing_actuator.h>
 *
 * @author Miquel Kegeleirs <miquel.kegeleirs@ulb.be>
 */

#ifndef CCI_RVR_RANGE_AND_BEARING_ACTUATOR_H
#define CCI_RVR_RANGE_AND_BEARING_ACTUATOR_H

namespace argos {
class CCI_RVRRangeAndBearingActuator;
}
...
class CCI_RVRRangeAndBearingActuator : public CCI_Actuator {
public:
...
public:
    ...
    virtual ~CCI_RVRRangeAndBearingActuator() {}
