/**
 * @file <argos3/plugins/robots/rvr/control_interface/ci_rvr_range_and_bearing_sensor.cpp>
 *
 * @author Miquel Kegeleirs <miquel.kegeleirs@ulb.be>
 */

#include "ci_rvr_range_and_bearing_sensor.h"
...
namespace argos {
   ...
   void CCI_RVRRangeAndBearingSensor::Init(TConfigurationNode& t_node) {
   ...
   void CCI_RVRRangeAndBearingSensor::ClearPackets() {
...
#ifdef ARGOS_WITH_LUA
   void CCI_RVRRangeAndBearingSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_RVRRangeAndBearingSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& os,
                            const CCI_RVRRangeAndBearingSensor::SReceivedPacket & t_packet) {
