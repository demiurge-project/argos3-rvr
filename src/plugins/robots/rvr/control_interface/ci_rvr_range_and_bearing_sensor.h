/**
 * @file <argos3/plugins/robots/rvr/control_interface/ci_rvr_range_and_bearing_sensor.h>
 *
...
#ifndef CCI_RVR_RANGE_AND_BEARING_SENSOR_H
#define CCI_RVR_RANGE_AND_BEARING_SENSOR_H

namespace argos {
   class CCI_RVRRangeAndBearingSensor;
}
...
namespace argos {
   ...
   class CCI_RVRRangeAndBearingSensor : public CCI_Sensor {
