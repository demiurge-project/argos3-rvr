#include "rvr_colored_blob_omnidirectional_camera_rotzonly_sensor.h"
...
namespace argos {
   ...
   public:
      ...
      COmnidirectionalCameraLEDCheckOperation(
         CCI_RVRColoredBlobOmnidirectionalCameraSensor::TBlobList& t_blobs,
      ...
      virtual bool operator()(CLEDEntity& c_led) {
         ...
         if(c_led.GetColor() != CColor::BLACK) {
            ...
            if(Abs(m_cLEDRelativePos.GetX()) < m_fGroundHalfRange &&
               ...
               m_tBlobs.push_back(new CCI_RVRColoredBlobOmnidirectionalCameraSensor::SBlob(
                                     c_led.GetColor(),
   ...
   private:
      ...
      CCI_RVRColoredBlobOmnidirectionalCameraSensor::TBlobList& m_tBlobs;
   ...
   CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor() :
      m_bEnabled(false),
   ...
   void CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::SetRobot(CComposableEntity& c_entity) {
   ...
   void CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::Init(TConfigurationNode& t_tree) {
      try {
         /* Parent class init */
         CCI_RVRColoredBlobOmnidirectionalCameraSensor::Init(t_tree);
         /* Show rays? */
   ...
   void CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::Update() {
      if(m_bEnabled) {
   ...
   void CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::Reset() {
   ...
   void CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::Destroy() {
   ...
   void CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::Enable() {
   ...
   void CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor::Disable() {
   ...
   REGISTER_SENSOR(CRVRColoredBlobOmnidirectionalCameraRotZOnlySensor,
                   "rvr_colored_blob_omnidirectional_camera", "rot_z_only",
                   ...
                   "      <sensors>\n"
                   "        ...\n"
                   "        <rvr_colored_blob_omnidirectional_camera implementation=\"rot_z_only\"\n"
                   "                                             medium=\"leds\" />\n"
                   "                                             show_rays=\"true\" />\n"
                   "        ...\n"
                   "      </sensors>\n"
