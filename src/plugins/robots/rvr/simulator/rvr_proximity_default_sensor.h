/**
 * @file <argos3/plugins/robots/rvr/simulator/rvr_proximity_default_sensor.h>
 *
 * @author Raffaele Todesco - <raffaele.todesco@ulb.be>
 */

#ifndef RVR_PROXIMITY_DEFAULT_SENSOR_H
#define RVR_PROXIMITY_DEFAULT_SENSOR_H

namespace argos
{
    class CRVRProximityDefaultSensor;
}

#include "../control_interface/ci_rvr_proximity_sensor.h"
...
namespace argos
{
    ...
    class CRVRProximityDefaultSensor : public CSimulatedSensor,
                                       public CCI_RVRProximitySensor
    {

    public:
        CRVRProximityDefaultSensor();

        virtual ~CRVRProximityDefaultSensor() {}
