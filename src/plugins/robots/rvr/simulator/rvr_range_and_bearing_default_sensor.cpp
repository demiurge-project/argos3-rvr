/**
 * @file <argos3/plugins/robots/rvr/simulator/rvr_rab_default_sensor.cpp>
 *
 *
 * @author Miquel Kegeleirs <miquel.kegeleirs@ulb.be>
 */
#include <limits>
#include "rvr_range_and_bearing_default_sensor.h"
...
namespace argos {
static const Real RVR_RADIUS = 14.3f;
/****************************************/
/****************************************/
...
CRVRRABDefaultSensor::CRVRRABDefaultSensor() :
...
void CRVRRABDefaultSensor::SetRobot(CComposableEntity& c_entity) {
...
void CRVRRABDefaultSensor::Init(TConfigurationNode& t_tree) {
    try {
        /* Parent class init */
        CCI_RVRRangeAndBearingSensor::Init(t_tree);
        /* Show rays? */
...
void CRVRRABDefaultSensor::Update() {
    ...
    CCI_RVRRangeAndBearingSensor::SReceivedPacket* psReceivedPacket = NULL;
    /* Pointer to the RAB entity sending the packet */
    CRVRRABEquippedEntity* pcRABSendingEquipedEntity = NULL;
    /* Go through communicating RABs and create packets */
    size_t unSize=setRABs.size();
    CRVRRABEquippedEntity* vRABentities[unSize];
	...
	vRABentities[indexes.at(selectedIndex)]=static_cast<CRVRRABEquippedEntity*>(*itRABSendingEquipedEntity);
    ...
    for (size_t i = 0; i < unSize && unMessagesNeeded>0; ++i) {
         ...
         */
        CCI_RVRRangeAndBearingActuator::SEmitter& em=pcRABSendingEquipedEntity->GetEmitterForAngle(cReceiverToSenderAngle);
        if(em.Enabled){
            ...
            if(m_fLossProbability==0.0f || !m_pcRNG->Bernoulli(m_fLossProbability)){
                ...
                psReceivedPacket = new CCI_RVRRangeAndBearingSensor::SReceivedPacket();
                ...
                psReceivedPacket->Range-=2*RVR_RADIUS;
                if(m_bRealRangeNoise){
                    /** Add noise
...
void CRVRRABDefaultSensor::Reset() {
    ClearPackets();
}
...
void CRVRRABDefaultSensor::Destroy() {
    ClearPackets();
...
REGISTER_SENSOR(CRVRRABDefaultSensor,
                "rvr_range_and_bearing", "medium",
                "Gianpiero Francesca - [gianpiero.francesca@ulb.ac.be]"
                "Lorenzo Garattoni- [lgaratto@ulb.ac.be]",
                "2.0",
                "The range-and-bearing sensor of the rvr.",
                "This sensor allows rvrs to perform situated communication, i.e., a form of\n"
                ...
                "This sensor allows a rvrs to receive messages. To send messages, you need the\n"
                "range-and-bearing actuator (\"rvr_range_and_bearing\" in the actuator section).\n"
                "For use, refer to [ci_rvr_range_and_bearing_sensor.h].\n\n"
                ...
                "         <sensors>\n"
                "            ...\n"
                "            <rvr_range_and_bearing implementation=\"medium\" medium=\"rab\" show_rays=\"false\" data_size=\"2\" noise_std_dev=\"0.0\" real_range_noise=\"false\" max_packets=\"UINT32_MAX\" loss_probability=\"0.0\"/>\n"
                "            ...\n"
                "         <sensors/>\n"
                "         ...\n"
                "      <my_controller/>\n"
                ...
                "         <sensors>\n"
                "            ...\n"
                "            <rvr_range_and_bearing implementation=\"medium\" medium=\"rab\" show_rays=\"true\"/>\n"
                "            ...\n"
                "         <sensors/>\n"
                "         ...\n"
                "      <my_controller/>\n"
